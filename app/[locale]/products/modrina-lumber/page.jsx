		...
		<div className={styles.container}>
			<div className={styles.row}>
				<div className={styles.section__title}>
					<span>{t('modrina')} {t('beam')} 30 * 500 mm</span>
...
<div className={styles.table}>
  ...
  <div className={styles.table__row}>
    ...
    <div className={styles.table__cell}>500</div>
    <div className={styles.table__cell}>500
	...
	<div className={styles.table__cell__3}>Certificate code FSC 100% - NC-COC-024736</div>
				...
				<div className={styles.col}>
                <Image className={styles.adaptive__img} src="/modrina-lumber-01.webp" alt="oak lumber 1" width={500} height={300} />
