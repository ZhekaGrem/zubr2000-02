						...
						<div className={styles.team__member__hover}>
							<div className={styles.team__member__info}>
								...
								<div className={styles.team__member__job}>
									<Link    rel='preload' href='/products/oak-lumber#oak__02'>{t('open')}</Link></div>
							</div>
						</div>
					</div>
				</div>
						...
						<div className={styles.team__member__hover}>
							<div className={styles.team__member__info}>
								...
								<div className={styles.team__member__job}>
									<Link    
									rel='preload'
									 href='/products/oak-lumber#oak__01'>
										{t('open')}
										</Link></div>
							</div>
						</div>
						...
						<div className={styles.team__member__hover}>
							<div className={styles.team__member__info}>
								...
								<div className={styles.team__member__job}>
									<Link    
									rel='preload' 
									href='/products/oak-lumber#oak__03'>
										{t('open')}</Link></div>
							</div>
						</div>
					</div>				
						...
						<div className={styles.team__member__hover}>
							<div className={styles.team__member__info}>
								...
								<div className={styles.team__member__job}>
									<Link    
									rel='preload' 
									href='/products/ash-lumber#ash__01'>
										{t('open')}
										</Link></div>
							</div>
						</div>
