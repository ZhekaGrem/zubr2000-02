...
<section>
		<div className={styles.container}>
			...
			<div className={styles.row}>
				<div className={styles.col}>
					<div className={styles.team__member}>
          <Image className={styles.info__img} alt="birch lumber 2" src="/birch-lumber-01.webp" width={400} height={400}/>
						<div className={styles.team__member__hover}>
							<div className={styles.team__member__info}>
								<div className={styles.team__member__name}>{t('beam')} 54 * 110 ММ</div>
								<div className={styles.team__member__job}><Link    rel="preload" href='/products/oak-lumber'>open</Link></div>
				...
				<div className={styles.col} data-wow-delay=".1s">
					<div className={styles.team__member}>
          <Image className={styles.info__img} src="/birch-lumber-02.webp" alt="birch lumber 1" width={400} height={400}/>
						<div className={styles.team__member__hover}>
							<div className={styles.team__member__info}>
								<div className={styles.team__member__name}>{t('beam')} 54 * 54 ММ</div>
								<div className={styles.team__member__job}><Link    rel="preload" href='/products/oak-lumber'>open</Link></div>
...
<section>
		<div   className={styles.container}>
			...
			<div className={styles.row}>
				<div className={styles.col}>
					<div className={styles.team__member}>
          <Image className={styles.info__img} src="/ash-lumber-01.webp" alt="ash lumber 2" width={400} height={400}/>
						<div className={styles.team__member__hover}>
							<div className={styles.team__member__info}>
								<div className={styles.team__member__name}>{t('beam')} 54 * 110 ММ</div>
								<div className={styles.team__member__job}><Link    rel="preload" href='/products/oak-lumber'>open</Link></div>
				...
				<div className={styles.col} data-wow-delay=".1s">
					<div className={styles.team__member}>
          <Image className={styles.info__img} src="/ash-lumber-02.webp" alt="ash lumber 1" width={400} height={400}/>
						<div className={styles.team__member__hover}>
							<div className={styles.team__member__info}>
								<div className={styles.team__member__name}>{t('beam')} 54 * 54 ММ</div>
								<div className={styles.team__member__job}><Link    rel="preload" href='/products/oak-lumber'>open</Link></div>
