...
// English is the x-default (universal fallback) for EU export buyers whose
// language isn't among the 9 supported locales.
const X_DEFAULT_LOCALE = "en";

export function buildAlternates(path) {
  const normalized = path.startsWith("/") ? path : `/${path}`;
  const languages = {
    "x-default": `${SITE_URL}/${X_DEFAULT_LOCALE}${normalized === "/" ? "" : normalized}`,
  };
...
export function organizationJsonLd() {
  return {
    ...
    address: {
      "@type": "PostalAddress",
      streetAddress: "20 Mykola Kopernika St.",
    ...
    email: "zubrzubr2000@gmail.com",
    contactPoint: [
      {
        "@type": "ContactPoint",
        contactType: "sales",
        telephone: "+380971362000",
        email: "zubrzubr2000@gmail.com",
        areaServed: ["UA", "IT", "SE", "SK", "PL", "EE", "DK", "DE", "FR"],
        availableLanguage: ["uk", "en", "pl", "de", "ru", "fr", "it", "sv", "da"],
      },
    ],
    sameAs: [
